...
interface and a lower number of dependencies._
...
As noted this module is no longer a drop in replacement for
`Net::Amazon::S3` and has limitations that may make the use of this
module in your applications questionable. This may not be a complete
list of those limitations.
